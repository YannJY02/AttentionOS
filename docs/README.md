...
5. `plans/2026-05-13-attentionos-experience-alignment-implementation-slice.md` — implemented and QA-verified Execution Plan/Focus slice for the accepted experience work.
6. `plans/2026-05-10-attentionos-experience-alignment-review-gate-blocker.md` — historical review-gate blocker and record of the owner-approved chat fallback.
7. `plans/2026-05-09-phase-4-intake.md` — draft Phase 4 intake for protocol and extension scope.
8. `plans/2026-05-09-phase-3-evolutionary-learning-ledger.md` — verified Phase 3 implementation ledger.
9. `plans/2026-05-09-phase-2-completion-ledger.md` — Phase 2 AI reasoning closeout ledger.
10. `governance/ai-generated-doc-workflow.md` — required routing, naming, update, and archive workflow for AI-generated docs.
11. `work/todo.md` — non-authoritative developer intake queue for early ideas and untriaged work.
12. `governance/documentation-automation.md` — low-risk automation and check triggers for documentation governance.
