...
export type WorkflowOptimizationSuggestion = GuidanceSuggestion<WorkflowOptimizationPayload> & {
...
export type CreateWorkflowOptimizationSuggestionInput =
  CreateGuidanceSuggestionInput<WorkflowOptimizationPayload> & {
    readonly kind: 'workflow_optimization';
